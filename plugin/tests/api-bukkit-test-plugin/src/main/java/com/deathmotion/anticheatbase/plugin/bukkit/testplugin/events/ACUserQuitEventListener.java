package com.deathmotion.anticheatbase.plugin.bukkit.testplugin.events;
...
import com.deathmotion.anticheatbase.plugin.bukkit.testplugin.ApiTestPlugin;
...
public class ACUserQuitEventListener {
    ...
    public void onUserJoin(ACUserQuitEvent event) {
        plugin.getLogger().info("User " + event.getUser().getName() + " has quit the server.");
    }
}
